function show_me_the_image (perception_bag_i)
resolution=[768,480];
...
for i=1:1:size(perception_bag_i{2},1)
     image0=insertShape(image0,'line',[perception_bag_i{2}(i,1) perception_bag_i{2}(i,2) perception_bag_i{2}(i,3) perception_bag_i{2}(i,4)], 'LineWidth', 3,'Color','blue');
end
imshow(image0);