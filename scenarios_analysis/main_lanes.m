...
lamps_pole = load_lamps_1234(1);
lanes_line = load_lanes_1234(num_lanes);
traffic_signs = load_tfs(1);
%轨迹定义`
...
for run_time =1:1:200
    ...
    %%生成带噪声数据
    %生成感知、生成地图
    perception_bag = generate_perception_scale(trajectory_tru,lamps_pole,lanes_line,traffic_signs,noice_camera);%加噪声
