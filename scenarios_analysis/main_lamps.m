...
for num_lamps = 2:1:5
    ...
    lamps_pole = load_lamps_1234(num_lamps);
    lanes_line = load_lanes_1234(1);
...
%         steps = [6 23 39 56 73];%分别对应距离：75 60 45 30 15m
        steps = [ 35 45 56 67];%分别对应距离： 50 40 30  20m

        for i_position = 1:1:1
